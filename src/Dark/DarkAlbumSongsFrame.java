...
////    }
//
//    public DarkAlbumSongsFrame(playList playlist){
//        super();
...
//    }
    ...
    public DarkAlbumSongsFrame(String albumName , String artistName){
        super();
        setLayout(new BorderLayout());
//        JPanel header = new JPanel(new BorderLayout());
        setSize(new Dimension(600,500));
        ...
        playlistHeaderNameTitle = new JLabel(albumName);
        playlistHeaderDescription = new JLabel("By : "+artistName );
