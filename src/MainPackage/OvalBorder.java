...
public class OvalBorder implements Border {
    ...
    protected Color lightColor =MyColors.DarkLeftBar;

    protected Color darkColor = MyColors.DarkLeftBar;

    public OvalBorder() {
        ovalWidth = 6;
        ovalHeight = 6;
        lightColor = MyColors.DarkTextColor;
        darkColor = MyColors.DarkTextColor;
    }
...
//        g.setColor(MyColors.DarkLeftBar);
